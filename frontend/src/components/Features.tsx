     ...
     <h2 className="text-3xl font-semibold">Why Reflectify Me?</h2>
      ...
      <div className="grid gap-8 md:grid-cols-3 max-w-5xl mx-auto">
        <div className="p-6 bg-white rounded-xl shadow hover:shadow-md transition">
          <PenLine className="w-8 h-8 mx-auto mb-4 text-teal-600" />
        ...
        <div className="p-6 bg-white rounded-xl shadow hover:shadow-md transition">
          <Sparkles className="w-8 h-8 mx-auto mb-4 text-teal-600" />
        ...
        <div className="p-6 bg-white rounded-xl shadow hover:shadow-md transition">
          <Heart className="w-8 h-8 mx-auto mb-4 text-teal-600" />
